...
//        System.out.println("公钥："+ Base64.encode(publicKey,DEFAULT));
//        System.out.println("私钥："+ Base64.encode(privateKey,DEFAULT));
//
//        byte[] encryptByPublicKey = encryptByPublicKey(password.getBytes(), publicKey);
//        System.out.println("使用公钥加密后的数据："+Base64.encode(encryptByPublicKey,DEFAULT));
//
